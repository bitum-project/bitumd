...
/*
Package addrmgr implements concurrency safe Bitum address manager.

Address Manager Overview

In order maintain the peer-to-peer Bitum network, there needs to be a source
of addresses to connect to as nodes come and go.  The Bitum protocol provides
