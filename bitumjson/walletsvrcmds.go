...
//
// DEPRECATED.  This will be removed in the next major version bump of bitumjson.
...
type SendManyCmd struct {
	FromAccount string
	Amounts     map[string]float64 `jsonrpcusage:"{\"address\":amount,...}"` // In BITUM
	MinConf     *int               `jsonrpcdefault:"1"`
	Comment     *string
}
...
// the SignRawTransactionCmd struct.  Contains Bitum additions.
