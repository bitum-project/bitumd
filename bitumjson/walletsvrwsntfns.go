...
const (
	...
	DcrdConnectedNtfnMethod = "bitumdconnected"
	...
	// RevocationCreatedNtfnMethod is the method of the bitumwallet
	...
	// TicketPurchasedNtfnMethod is the method of the bitumwallet
	// ticketpurchased notification.
	TicketPurchasedNtfnMethod = "ticketpurchased"

	// VoteCreatedNtfnMethod is the method of the bitumwallet
...
// DcrdConnectedNtfn defines the bitumddconnected JSON-RPC notification.
type DcrdConnectedNtfn struct {
	Connected bool
}

// NewDcrdConnectedNtfn returns a new instance which can be used to issue a
// bitumddconnected JSON-RPC notification.
