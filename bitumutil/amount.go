...
// units, "1eN BITUM" is returned, where N is the AmountUnit.
func (u AmountUnit) String() string {
	...
	case AmountAtom:
		return "Atom"
	default:
		return "1e" + strconv.FormatInt(int64(u), 10) + " BITUM"
	}
}
...
//
// NewAmount is for specifically for converting BITUM to Atoms (atomic units).
...
// See GoDoc for example: http://godoc.org/github.com/bitum-project/bitumd/bitumutil#example-Amount
...
// useful for services that build on top of Bitum (for example, calculating
