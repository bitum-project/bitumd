...
func TestAmountMulF64(t *testing.T) {
	tests := []struct {
		...
		{
			name: "Multiply 0.1 BITUM by 2",
			amt:  100e5, // 0.1 BITUM
			mul:  2,
			res:  200e5, // 0.2 BITUM
		},
		{
			name: "Multiply 0.2 BITUM by 0.02",
			amt:  200e5, // 0.2 BITUM
			mul:  1.02,
			res:  204e5, // 0.204 BITUM
		},
		{
			name: "Multiply 0.1 BITUM by -2",
			amt:  100e5, // 0.1 BITUM
