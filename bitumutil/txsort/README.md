...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bitum-project/bitumd/bitumutil/txsort)
...
differences with Bitum-specific transactions.
...
```bash
$ go get -u github.com/bitum-project/bitumd/bitumutil/txsort
```
