...
func NewWIF(privKey chainec.PrivateKey, net *chaincfg.Params, ecType bitumec.SignatureType) (*WIF,
	error) {
	if net == nil {
...
func DecodeWIF(wif string) (*WIF, error) {
	...
	var ecType bitumec.SignatureType
	switch bitumec.SignatureType(decoded[2]) {
	...
	case bitumec.STEd25519:
		...
		ecType = bitumec.STEd25519
	case bitumec.STSchnorrSecp256k1:
		privKeyBytes := decoded[3 : 3+secp256k1.PrivKeyBytesLen]
		privKey, _ = secp256k1.PrivKeyFromScalar(privKeyBytes)
		ecType = bitumec.STSchnorrSecp256k1
	}
...
func (w *WIF) DSA() bitumec.SignatureType {
	return w.ecType
}
