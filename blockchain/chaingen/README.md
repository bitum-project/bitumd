...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bitum-project/bitumd/blockchain/chaingen)
...
* [Basic Usage Example]
  (http://godoc.org/github.com/bitum-project/bitumd/blockchain/chaingen#example-package--BasicUsage)  
...
```bash
$ go get -u github.com/bitum-project/bitumd/blockchain/chaingen
```
