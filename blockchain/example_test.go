...
// overview documentation describes, this includes all of the Bitum consensus
...
func ExampleBlockChain_ProcessBlock() {
	...
	// exists.
	genesisBlock := bitumutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
...
func ExampleCompactToBig() {
	// Convert the bits from block 300000 in the main Bitum block chain.
