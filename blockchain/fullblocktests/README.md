...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bitum-project/bitumd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/bitum-project/bitumd/blockchain/fullblocktests
```
