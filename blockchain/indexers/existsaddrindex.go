...
func (idx *ExistsAddrIndex) ExistsAddress(addr bitumutil.Address) (bool, error) {
...
func (idx *ExistsAddrIndex) ExistsAddresses(addrs []bitumutil.Address) ([]bool, error) {
...
//
// This is part of the Indexer interface.
func (idx *ExistsAddrIndex) ConnectBlock(dbTx database.Tx, block, parent *bitumutil.Block, view *blockchain.UtxoViewpoint) error {
	...
	blockTxns := make([]*bitumutil.Tx, 0, len(block.Transactions())+
...
//
// This is part of the Indexer interface.
func (idx *ExistsAddrIndex) DisconnectBlock(dbTx database.Tx, block, parent *bitumutil.Block, view *blockchain.UtxoViewpoint) error {
