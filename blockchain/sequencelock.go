...
func (b *BlockChain) calcSequenceLock(node *blockNode, tx *bitumutil.Tx, view *UtxoViewpoint, isActive bool) (*SequenceLock, error) {
...
func (b *BlockChain) CalcSequenceLock(tx *bitumutil.Tx, view *UtxoViewpoint) (*SequenceLock, error) {
	b.chainLock.Lock()
