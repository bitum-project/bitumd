...
func TestSStx(t *testing.T) {
	var sstx = bitumutil.NewTx(sstxMsgTx)
	...
	sstx = bitumutil.NewTxDeep(sstxMsgTx)
...
func TestSSTxErrors(t *testing.T) {
	...
	var sstxExtraInputs = bitumutil.NewTx(sstxMsgTxExtraInput)
	...
	var sstxExtraOutputs = bitumutil.NewTx(sstxMsgTxExtraOutputs)
	...
	var sstxUntaggedOut = bitumutil.NewTx(&tx)
	...
	var sstxInsOutsMismatched = bitumutil.NewTx(sstxMismatchedInsOuts)
	...
	var sstxBadVerOut = bitumutil.NewTx(sstxBadVersionOut)
	...
	var sstxNoNullData = bitumutil.NewTx(sstxNullDataMissing)
	...
	var sstxNullDataMis = bitumutil.NewTx(sstxNullDataMisplaced)
	...
	var sstxWrongPKHLength = bitumutil.NewTx(&tx)
	...
	var sstxWrongPrefix = bitumutil.NewTx(&tx)
...
func TestSSGen(t *testing.T) {
	var ssgen = bitumutil.NewTx(ssgenMsgTx)
	...
	ssgen = bitumutil.NewTxDeep(ssgenMsgTx)
	ssgen.SetTree(wire.TxTreeStake)
	ssgen.SetIndex(0)
...
func TestSSGenErrors(t *testing.T) {
	...
	var ssgenExtraInputs = bitumutil.NewTx(ssgenMsgTxExtraInput)
	...
	var ssgenExtraOutputs = bitumutil.NewTx(ssgenMsgTxExtraOutputs)
	...
	var ssgenStakeBaseWrong = bitumutil.NewTx(ssgenMsgTxStakeBaseWrong)
	...
	var ssgenWrongTreeIns = bitumutil.NewTx(&tx)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssgenTxBadVerOut = bitumutil.NewTx(ssgenMsgTxBadVerOut)
	...
	var ssgenWrongZeroethOut = bitumutil.NewTx(ssgenMsgTxWrongZeroethOut)
	...
	var ssgenWrongDataPush0Length = bitumutil.NewTx(&tx)
	...
	var ssgenWrongNullData0Prefix = bitumutil.NewTx(&tx)
	...
	var ssgenWrongFirstOut = bitumutil.NewTx(ssgenMsgTxWrongFirstOut)
	...
	var ssgenWrongDataPush1Length = bitumutil.NewTx(&tx)
	...
	var ssgenWrongNullData1Prefix = bitumutil.NewTx(&tx)
	...
	var ssgentestGenOutputUntagged = bitumutil.NewTx(&tx)
...
func TestSSRtx(t *testing.T) {
	var ssrtx = bitumutil.NewTx(ssrtxMsgTx)
...
func TestIsSSRtxErrors(t *testing.T) {
	...
	var ssrtxTooManyInputs = bitumutil.NewTx(ssrtxMsgTxTooManyInputs)
	...
	var ssrtxTooManyOutputs = bitumutil.NewTx(ssrtxMsgTxTooManyOutputs)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssrtxTxBadVerOut = bitumutil.NewTx(ssrtxMsgTxBadVerOut)
	...
	var ssrtxTestRevocOutputUntagged = bitumutil.NewTx(&tx)
	...
	var ssrtxWrongTreeIns = bitumutil.NewTx(&tx)
