...
func BlockOneCoinbasePaysTokens(tx *bitumutil.Tx, params *chaincfg.Params) error {
	...
	for i, txout := range tx.MsgTx().TxOut {
		...
		addrLedger, err := bitumutil.DecodeAddress(ledger[i].Address)
		if err != nil {
			return err
		}
...
func CoinbasePaysTax(subsidyCache *SubsidyCache, tx *bitumutil.Tx, height int64, voters uint16, params *chaincfg.Params) error {
...
func CalculateAddedSubsidy(block, parent *bitumutil.Block) int64 {
	var subsidy int64
