...
//
// In addition to the main Bitum network, which is intended for the transfer
...
// wire.BitumNet using ParamsForNet, but be aware that this usage is
...
//          addr, err := bitumutil.NewAddressPubKeyHash(pubKeyHash, chainParams)
//          if err != nil {
//                  log.Fatal(err)
//          }
//          fmt.Println(addr)
//  }
//
// If an application does not use one of the three standard Bitum networks,
