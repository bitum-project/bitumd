...
var (
	...
	// mainPowLimit is the highest proof of work value a Bitum block can
	// have for the main network.  It is the value 2^224 - 1.
	mainPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 224), bigOne)

	// testNetPowLimit is the highest proof of work value a Bitum block
	// can have for the test network.  It is the value 2^232 - 1.
	testNetPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 232), bigOne)

	// simNetPowLimit is the highest proof of work value a Bitum block
	// can have for the simulation test network.  It is the value 2^255 - 1.
	simNetPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 255), bigOne)

	// regNetPowLimit is the highest proof of work value a Bitum block
...
// Params defines a Bitum network by its parameters.  These parameters may be
// used by Bitum applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Ticket pool sizes for Bitum PoS. This denotes the number of possible
	...
	// Average number of tickets per block for Bitum PoS.
...
var (
	// ErrDuplicateNet describes an error where the parameters for a Bitum
	// network could not be set due to the network already being a standard
	// network or previously-registered into this package.
	ErrDuplicateNet = errors.New("duplicate Bitum network")
...
// Register registers the network parameters for a Bitum network.  This may
