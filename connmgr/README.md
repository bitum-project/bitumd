...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bitum-project/bitumd/connmgr)

Package connmgr implements a generic Bitum network connection manager.
...
```bash
$ go get -u github.com/bitum-project/bitumd/connmgr
```
