...
/*
bitumd is a full-node Bitum implementation written in Go.

The default options are sane for most users.  This means bitumd will work 'out of
...
parsed when bitumd starts up.  By default, the configuration file is located at
~/.bitumd/bitumd.conf on POSIX-style operating systems and %LOCALAPPDATA%\bitumd\bitumd.conf
...
Application Options:
  ...
  -d, --debuglevel=         Logging level for all subsystems {trace, debug,
      ...
      --minrelaytxfee=      The minimum transaction fee in BITUM/kB to be
      ...
      --altdnsnames:        Specify additional dns names to use when
                            ...
                            [supports BITUMD_ALT_DNSNAMES environment variable]
