...
reason, the bitumd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire bitumd
...
One of the major design goals of all core bitumd packages is to aim for complete
...
- If a commit modifies a component in any of the packages besides the main
  package use the package name as the commit prefix (eg. `bitumjson`).
...
contributions.  This is how to get your changes into bitumd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/bitum-project/bitumd/graphs/contributors)!
...
[ISC license](https://github.com/bitum-project/bitumd/blob/master/LICENSE).  This is
the same license as all of the code in the bitumd suite.
