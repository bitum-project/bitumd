...
Although it was primarily written for bitumd, this package has intentionally been
...
second layer alternatives, etc). Also, the current fill rate of blocks in bitum
...
out earlier should be sufficient for current fill rate of bitum's network.
...
bitumfeesim tool available in [6].
...
[5] Source for the original bitumfeesim and estimator work:
https://github.com/matheusd/bitumfeesim_dev

[6] Source for the current bitumfeesim, using this module:
https://github.com/matheusd/bitumfeesim
*/
package fees
