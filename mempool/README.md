...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bitum-project/bitumd/mempool)

Package mempool provides a policy-enforced pool of unmined Bitum transactions.

A key responsibility of the Bitum network is mining transactions – regular
...
Since this package does not deal with other Bitum specifics such as network
...
package for any projects needing the ability create an in-memory pool of Bitum
...
```bash
$ go get -u github.com/bitum-project/bitumd/mempool
```
