...
const (
	...
	DefaultMinRelayTxFee = bitumutil.Amount(1e4)
...
// pool and relayed.
func calcMinRequiredTxRelayFee(serializedSize int64, minRelayTxFee bitumutil.Amount) int64 {
	...
	if minFee < 0 || minFee > bitumutil.MaxAmount {
		minFee = bitumutil.MaxAmount
	}
...
func checkInputsStandard(tx *bitumutil.Tx, txType stake.TxType, utxoView *blockchain.UtxoViewpoint) error {
...
func isDust(txOut *wire.TxOut, minRelayTxFee bitumutil.Amount) bool {
...
func checkTransactionStandard(tx *bitumutil.Tx, txType stake.TxType, height int64,
	medianTime time.Time, minRelayTxFee bitumutil.Amount,
