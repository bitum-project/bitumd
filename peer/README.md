...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bitum-project/bitumd/peer)
...
```bash
$ go get -u github.com/bitum-project/bitumd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/bitum-project/bitumd/peer#example-package--NewOutboundPeer)  
