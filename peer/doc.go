...
/*
Package peer provides a common base for creating and managing Bitum network
peers.

Overview

This package builds upon the wire package, which provides the fundamental
primitives necessary to speak the Bitum wire protocol, in order to simplify
...
A quick overview of the major features peer provides are as follows:
 ...
 - Provides a basic concurrent safe Bitum peer for handling bitum
   communications via the peer-to-peer protocol
 - Full duplex reading and writing of Bitum protocol messages
 ...
 - Flexible peer configuration
   ...
   - Ability to register callbacks for handling Bitum protocol messages
...
caller to specify things such as the user agent name and version, the bitum
network to use, which services it supports, and callbacks to invoke when bitum
...
In order to do anything useful with a peer, it is necessary to react to bitum
...
For convenience, a callback hook for all of the currently supported bitum
...
(https://godoc.org/github.com/bitum-project/bitumd/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
