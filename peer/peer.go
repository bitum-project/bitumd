...
// Peer provides a basic concurrent safe Bitum peer for handling bitum
...
// callbacks for handling Bitum protocol messages.
//
...
// newPeerBase returns a new base Bitum peer based on the inbound flag.  This
...
// NewInboundPeer returns a new inbound Bitum peer. Use Start to begin
// processing incoming and outgoing messages.
func NewInboundPeer(cfg *Config) *Peer {
	return newPeerBase(cfg, true)
}

// NewOutboundPeer returns a new outbound Bitum peer.
