...
func (c *Client) GetBestBlockHashAsync() FutureGetBestBlockHashResult {
	cmd := bitumjson.NewGetBestBlockHashCmd()
...
func (c *Client) GetBlockAsync(blockHash *chainhash.Hash) FutureGetBlockResult {
	...
	cmd := bitumjson.NewGetBlockCmd(hash, bitumjson.Bool(false), nil)
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockVerboseResult) Receive() (*bitumjson.GetBlockVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var blockResult bitumjson.GetBlockVerboseResult
...
func (c *Client) GetBlockVerboseAsync(blockHash *chainhash.Hash, verboseTx bool) FutureGetBlockVerboseResult {
	...
	cmd := bitumjson.NewGetBlockCmd(hash, bitumjson.Bool(true), &verboseTx)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockVerbose(blockHash *chainhash.Hash, verboseTx bool) (*bitumjson.GetBlockVerboseResult, error) {
...
func (c *Client) GetBlockCountAsync() FutureGetBlockCountResult {
	cmd := bitumjson.NewGetBlockCountCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetDifficultyAsync() FutureGetDifficultyResult {
	cmd := bitumjson.NewGetDifficultyCmd()
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockChainInfoResult) Receive() (*bitumjson.GetBlockChainInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var blockchainInfoRes bitumjson.GetBlockChainInfoResult
...
func (c *Client) GetBlockChainInfoAsync() FutureGetBlockChainInfoResult {
	cmd := bitumjson.NewGetBlockChainInfoCmd()
	return c.sendCmd(cmd)
}

// GetBlockChainInfo returns information about the current state of the block
// chain.
func (c *Client) GetBlockChainInfo() (*bitumjson.GetBlockChainInfoResult, error) {
...
func (c *Client) GetBlockHashAsync(blockHeight int64) FutureGetBlockHashResult {
	cmd := bitumjson.NewGetBlockHashCmd(blockHeight)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderAsync(hash *chainhash.Hash) FutureGetBlockHeaderResult {
	cmd := bitumjson.NewGetBlockHeaderCmd(hash.String(), bitumjson.Bool(false))
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockHeaderVerboseResult) Receive() (*bitumjson.GetBlockHeaderVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var bh bitumjson.GetBlockHeaderVerboseResult
...
func (c *Client) GetBlockHeaderVerboseAsync(hash *chainhash.Hash) FutureGetBlockHeaderVerboseResult {
	cmd := bitumjson.NewGetBlockHeaderCmd(hash.String(), bitumjson.Bool(true))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderVerbose(hash *chainhash.Hash) (*bitumjson.GetBlockHeaderVerboseResult, error) {
...
func (r FutureGetBlockSubsidyResult) Receive() (*bitumjson.GetBlockSubsidyResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal the result
	var bs bitumjson.GetBlockSubsidyResult
...
func (c *Client) GetBlockSubsidyAsync(height int64, voters uint16) FutureGetBlockSubsidyResult {
	cmd := bitumjson.NewGetBlockSubsidyCmd(height, voters)
	return c.sendCmd(cmd)
}

// GetBlockSubsidy returns a data structure of the block subsidy
// from the server given its height and number of voters.
func (c *Client) GetBlockSubsidy(height int64, voters uint16) (*bitumjson.GetBlockSubsidyResult, error) {
...
// Receive waits for the response promised by the future and returns the
// current coin supply
func (r FutureGetCoinSupplyResult) Receive() (bitumutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	return bitumutil.Amount(cs), nil
}
...
func (c *Client) GetCoinSupplyAsync() FutureGetCoinSupplyResult {
	cmd := bitumjson.NewGetCoinSupplyCmd()
	return c.sendCmd(cmd)
}

// GetCoinSupply returns the current coin supply
func (c *Client) GetCoinSupply() (bitumutil.Amount, error) {
...
func (c *Client) GetRawMempoolAsync(txType bitumjson.GetRawMempoolTxTypeCmd) FutureGetRawMempoolResult {
	cmd := bitumjson.NewGetRawMempoolCmd(bitumjson.Bool(false),
		bitumjson.String(string(txType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawMempool(txType bitumjson.GetRawMempoolTxTypeCmd) ([]*chainhash.Hash, error) {
...
func (r FutureGetRawMempoolVerboseResult) Receive() (map[string]bitumjson.GetRawMempoolVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// results.
	var mempoolItems map[string]bitumjson.GetRawMempoolVerboseResult
...
func (c *Client) GetRawMempoolVerboseAsync(txType bitumjson.GetRawMempoolTxTypeCmd) FutureGetRawMempoolVerboseResult {
	cmd := bitumjson.NewGetRawMempoolCmd(bitumjson.Bool(true),
		bitumjson.String(string(txType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawMempoolVerbose(txType bitumjson.GetRawMempoolTxTypeCmd) (map[string]bitumjson.GetRawMempoolVerboseResult, error) {
...
func (r FutureGetChainTipsResult) Receive() ([]bitumjson.GetChainTipsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal the result.
	var chainTips []bitumjson.GetChainTipsResult
...
func (c *Client) GetChainTipsAsync() FutureGetChainTipsResult {
	cmd := bitumjson.NewGetChainTipsCmd()
	return c.sendCmd(cmd)
}

// GetChainTips returns all known tips in the block tree.
func (c *Client) GetChainTips() ([]bitumjson.GetChainTipsResult, error) {
...
func (c *Client) VerifyChainAsync() FutureVerifyChainResult {
	cmd := bitumjson.NewVerifyChainCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainLevelAsync(checkLevel int64) FutureVerifyChainResult {
	cmd := bitumjson.NewVerifyChainCmd(&checkLevel, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainBlocksAsync(checkLevel, numBlocks int64) FutureVerifyChainResult {
	cmd := bitumjson.NewVerifyChainCmd(&checkLevel, &numBlocks)
	return c.sendCmd(cmd)
}
...
func (r FutureGetTxOutResult) Receive() (*bitumjson.GetTxOutResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var txOutInfo *bitumjson.GetTxOutResult
...
func (c *Client) GetTxOutAsync(txHash *chainhash.Hash, index uint32, mempool bool) FutureGetTxOutResult {
	...
	cmd := bitumjson.NewGetTxOutCmd(hash, index, &mempool)
	return c.sendCmd(cmd)
}

// GetTxOut returns the transaction output info if it's unspent and
// nil, otherwise.
func (c *Client) GetTxOut(txHash *chainhash.Hash, index uint32, mempool bool) (*bitumjson.GetTxOutResult, error) {
...
func (r FutureRescanResult) Receive() (*bitumjson.RescanResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var rescanResult *bitumjson.RescanResult
...
func (c *Client) RescanAsync(blockHashes []chainhash.Hash) FutureRescanResult {
	...
	cmd := bitumjson.NewRescanCmd(hex.EncodeToString(concatenatedBlockHashes))
	return c.sendCmd(cmd)
}
...
func (c *Client) Rescan(blockHashes []chainhash.Hash) (*bitumjson.RescanResult, error) {
...
func (c *Client) GetCFilterAsync(blockHash *chainhash.Hash, filterType wire.FilterType) FutureGetCFilterResult {
	...
	cmd := bitumjson.NewGetCFilterCmd(blockHash.String(), ft)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetCFilterHeaderAsync(blockHash *chainhash.Hash, filterType wire.FilterType) FutureGetCFilterHeaderResult {
	...
	cmd := bitumjson.NewGetCFilterHeaderCmd(blockHash.String(), ft)
	return c.sendCmd(cmd)
}
