...
//
// NOTE: This is a bitumd extension.
func (c *Client) DebugLevelAsync(levelSpec string) FutureDebugLevelResult {
	cmd := bitumjson.NewDebugLevelCmd(levelSpec)
	return c.sendCmd(cmd)
}
...
func (r FutureEstimateStakeDiffResult) Receive() (*bitumjson.EstimateStakeDiffResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var est bitumjson.EstimateStakeDiffResult
...
func (c *Client) EstimateStakeDiffAsync(tickets *uint32) FutureEstimateStakeDiffResult {
	cmd := bitumjson.NewEstimateStakeDiffCmd(tickets)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a bitumd extension.
func (c *Client) EstimateStakeDiff(tickets *uint32) (*bitumjson.EstimateStakeDiffResult, error) {
...
// result of the RPC at some future time by invoking the Receive function on the
// returned instance.
func (c *Client) ExistsAddressAsync(address bitumutil.Address) FutureExistsAddressResult {
	cmd := bitumjson.NewExistsAddressCmd(address.EncodeAddress())
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a bitumd extension.
func (c *Client) ExistsAddress(address bitumutil.Address) (bool, error) {
...
// result of the RPC at some future time by invoking the Receive function on the
// returned instance.
func (c *Client) ExistsAddressesAsync(addresses []bitumutil.Address) FutureExistsAddressesResult {
	addrsStr := make([]string, len(addresses))
	for i := range addresses {
		addrsStr[i] = addresses[i].EncodeAddress()
	}

	cmd := bitumjson.NewExistsAddressesCmd(addrsStr)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a bitumd extension.
func (c *Client) ExistsAddresses(addresses []bitumutil.Address) (string, error) {
...
func (c *Client) ExistsMissedTicketsAsync(hashes []*chainhash.Hash) FutureExistsMissedTicketsResult {
	...
	cmd := bitumjson.NewExistsMissedTicketsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsExpiredTicketsAsync(hashes []*chainhash.Hash) FutureExistsExpiredTicketsResult {
	...
	cmd := bitumjson.NewExistsExpiredTicketsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsLiveTicketAsync(hash *chainhash.Hash) FutureExistsLiveTicketResult {
	cmd := bitumjson.NewExistsLiveTicketCmd(hash.String())
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsLiveTicketsAsync(hashes []*chainhash.Hash) FutureExistsLiveTicketsResult {
	...
	cmd := bitumjson.NewExistsLiveTicketsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsMempoolTxsAsync(hashes []*chainhash.Hash) FutureExistsMempoolTxsResult {
	...
	cmd := bitumjson.NewExistsMempoolTxsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExportWatchingWalletAsync(account string) FutureExportWatchingWalletResult {
	cmd := bitumjson.NewExportWatchingWalletCmd(&account, bitumjson.Bool(true))
	return c.sendCmd(cmd)
}
...
// used by bitumwallet to enable a wallet which does not have the private keys
...
func (r FutureGetBestBlockResult) Receive() (*chainhash.Hash, int64, error) {
	...
	var bestBlock bitumjson.GetBestBlockResult
...
func (c *Client) GetBestBlockAsync() FutureGetBestBlockResult {
	cmd := bitumjson.NewGetBestBlockCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetCurrentNetAsync() FutureGetCurrentNetResult {
	cmd := bitumjson.NewGetCurrentNetCmd()
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the
// getheaders result.
func (r FutureGetHeadersResult) Receive() (*bitumjson.GetHeadersResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var vr bitumjson.GetHeadersResult
...
func (c *Client) GetHeadersAsync(blockLocators []*chainhash.Hash, hashStop *chainhash.Hash) FutureGetHeadersResult {
	...
	cmd := bitumjson.NewGetHeadersCmd(hex.EncodeToString(concatenatedLocators),
		hashStop.String())
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetStakeDifficultyResult) Receive() (*bitumjson.GetStakeDifficultyResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a bitumjson.GetStakeDifficultyResult.
	var gsdr bitumjson.GetStakeDifficultyResult
...
func (c *Client) GetStakeDifficultyAsync() FutureGetStakeDifficultyResult {
	cmd := bitumjson.NewGetStakeDifficultyCmd()
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a bitumd extension.
func (c *Client) GetStakeDifficulty() (*bitumjson.GetStakeDifficultyResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetStakeVersionsResult) Receive() (*bitumjson.GetStakeVersionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a bitumjson.GetStakeVersionsResult.
	var gsvr bitumjson.GetStakeVersionsResult
...
func (c *Client) GetStakeVersionInfoAsync(count int32) FutureGetStakeVersionInfoResult {
	cmd := bitumjson.NewGetStakeVersionInfoCmd(count)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a bitumd extension.
func (c *Client) GetStakeVersionInfo(count int32) (*bitumjson.GetStakeVersionInfoResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetStakeVersionInfoResult) Receive() (*bitumjson.GetStakeVersionInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a bitumjson.GetStakeVersionInfoResult.
	var gsvr bitumjson.GetStakeVersionInfoResult
	err = json.Unmarshal(res, &gsvr)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetStakeVersionsAsync(hash string, count int32) FutureGetStakeVersionsResult {
	cmd := bitumjson.NewGetStakeVersionsCmd(hash, count)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a bitumd extension.
func (c *Client) GetStakeVersions(hash string, count int32) (*bitumjson.GetStakeVersionsResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetTicketPoolValueResult) Receive() (bitumutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amt, err := bitumutil.NewAmount(val)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetTicketPoolValueAsync() FutureGetTicketPoolValueResult {
	cmd := bitumjson.NewGetTicketPoolValueCmd()
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a bitumd extension.
func (c *Client) GetTicketPoolValue() (bitumutil.Amount, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetVoteInfoResult) Receive() (*bitumjson.GetVoteInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a bitumjson.GetVoteInfoResult.
	var gsvr bitumjson.GetVoteInfoResult
	err = json.Unmarshal(res, &gsvr)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetVoteInfoAsync(version uint32) FutureGetVoteInfoResult {
	cmd := bitumjson.NewGetVoteInfoCmd(version)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a bitumd extension.
func (c *Client) GetVoteInfo(version uint32) (*bitumjson.GetVoteInfoResult, error) {
...
func (r FutureListAddressTransactionsResult) Receive() ([]bitumjson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
//
// NOTE: This is a bitumd extension.
func (c *Client) ListAddressTransactionsAsync(addresses []bitumutil.Address, account string) FutureListAddressTransactionsResult {
	// Convert addresses to strings.
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.EncodeAddress())
	}
	cmd := bitumjson.NewListAddressTransactionsCmd(addrs, &account)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a bitumwallet extension.
func (c *Client) ListAddressTransactions(addresses []bitumutil.Address, account string) ([]bitumjson.ListTransactionsResult, error) {
...
func (r FutureLiveTicketsResult) Receive() ([]*chainhash.Hash, error) {
	...
	// Unmarshal the result as a bitumjson.LiveTicketsResult.
	var container bitumjson.LiveTicketsResult
...
func (c *Client) LiveTicketsAsync() FutureLiveTicketsResult {
	cmd := bitumjson.NewLiveTicketsCmd()
	return c.sendCmd(cmd)
}
...
func (r FutureMissedTicketsResult) Receive() ([]*chainhash.Hash, error) {
	...
	// Unmarshal the result as a bitumjson.MissedTicketsResult.
	var container bitumjson.MissedTicketsResult
	err = json.Unmarshal(res, &container)
	if err != nil {
		return nil, err
	}
...
func (c *Client) MissedTicketsAsync() FutureMissedTicketsResult {
	cmd := bitumjson.NewMissedTicketsCmd()
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the
// session result.
func (r FutureSessionResult) Receive() (*bitumjson.SessionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var session bitumjson.SessionResult
...
//
// NOTE: This is a Bitum extension.
...
//
// NOTE: This is a Bitum extension.
func (c *Client) Session() (*bitumjson.SessionResult, error) {
...
func (r FutureTicketFeeInfoResult) Receive() (*bitumjson.TicketFeeInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var tfir bitumjson.TicketFeeInfoResult
...
func (c *Client) TicketFeeInfoAsync(blocks *uint32, windows *uint32) FutureTicketFeeInfoResult {
	...
	cmd := bitumjson.NewTicketFeeInfoCmd(blocks, windows)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a Bitum extension.
func (c *Client) TicketFeeInfo(blocks *uint32, windows *uint32) (*bitumjson.TicketFeeInfoResult, error) {
...
// Receive waits for the response promised by the future and returns the
// ticketvwap result.
func (r FutureTicketVWAPResult) Receive() (bitumutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amt, err := bitumutil.NewAmount(vwap)
	if err != nil {
		return 0, err
	}
...
func (c *Client) TicketVWAPAsync(start *uint32, end *uint32) FutureTicketVWAPResult {
	...
	cmd := bitumjson.NewTicketVWAPCmd(start, end)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a Bitum extension.
func (c *Client) TicketVWAP(start *uint32, end *uint32) (bitumutil.Amount, error) {
...
// Receive waits for the response promised by the future and returns the
// txfeeinfo result.
func (r FutureTxFeeInfoResult) Receive() (*bitumjson.TxFeeInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var tfir bitumjson.TxFeeInfoResult
	err = json.Unmarshal(res, &tfir)
	if err != nil {
		return nil, err
	}
...
func (c *Client) TxFeeInfoAsync(blocks *uint32, start *uint32, end *uint32) FutureTxFeeInfoResult {
	...
	cmd := bitumjson.NewTxFeeInfoCmd(blocks, start, end)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a Bitum extension.
func (c *Client) TxFeeInfo(blocks *uint32, start *uint32, end *uint32) (*bitumjson.TxFeeInfoResult, error) {
...
// result.
func (r FutureVersionResult) Receive() (map[string]bitumjson.VersionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var vr map[string]bitumjson.VersionResult
	err = json.Unmarshal(res, &vr)
	if err != nil {
		return nil, err
	}
...
func (c *Client) VersionAsync() FutureVersionResult {
	cmd := bitumjson.NewVersionCmd()
	return c.sendCmd(cmd)
}

// Version returns information about the server's JSON-RPC API versions.
func (c *Client) Version() (map[string]bitumjson.VersionResult, error) {
