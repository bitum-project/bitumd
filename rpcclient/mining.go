...
func (c *Client) GenerateAsync(numBlocks uint32) FutureGenerateResult {
	cmd := bitumjson.NewGenerateCmd(numBlocks)
...
func (c *Client) GetGenerateAsync() FutureGetGenerateResult {
	cmd := bitumjson.NewGetGenerateCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) SetGenerateAsync(enable bool, numCPUs int) FutureSetGenerateResult {
	cmd := bitumjson.NewSetGenerateCmd(enable, &numCPUs)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetHashesPerSecAsync() FutureGetHashesPerSecResult {
	cmd := bitumjson.NewGetHashesPerSecCmd()
	return c.sendCmd(cmd)
}
...
// information.
func (r FutureGetMiningInfoResult) Receive() (*bitumjson.GetMiningInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoResult bitumjson.GetMiningInfoResult
...
func (c *Client) GetMiningInfoAsync() FutureGetMiningInfoResult {
	cmd := bitumjson.NewGetMiningInfoCmd()
	return c.sendCmd(cmd)
}

// GetMiningInfo returns mining information.
func (c *Client) GetMiningInfo() (*bitumjson.GetMiningInfoResult, error) {
...
func (c *Client) GetNetworkHashPSAsync() FutureGetNetworkHashPS {
	cmd := bitumjson.NewGetNetworkHashPSCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNetworkHashPS2Async(blocks int) FutureGetNetworkHashPS {
	cmd := bitumjson.NewGetNetworkHashPSCmd(&blocks, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNetworkHashPS3Async(blocks, height int) FutureGetNetworkHashPS {
	cmd := bitumjson.NewGetNetworkHashPSCmd(&blocks, &height)
	return c.sendCmd(cmd)
}
...
// data to work on.
func (r FutureGetWork) Receive() (*bitumjson.GetWorkResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result bitumjson.GetWorkResult
	err = json.Unmarshal(res, &result)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetWorkAsync() FutureGetWork {
	cmd := bitumjson.NewGetWorkCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetWork() (*bitumjson.GetWorkResult, error) {
...
func (c *Client) GetWorkSubmitAsync(data string) FutureGetWorkSubmit {
	cmd := bitumjson.NewGetWorkCmd(&data)
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockTemplate) Receive() (*bitumjson.GetBlockTemplateResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result.
	var gbt bitumjson.GetBlockTemplateResult
...
func (c *Client) GetBlockTemplateAsync(req *bitumjson.TemplateRequest) FutureGetBlockTemplate {
	cmd := bitumjson.NewGetBlockTemplateCmd(req)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockTemplate(req *bitumjson.TemplateRequest) (*bitumjson.GetBlockTemplateResult, error) {
...
func (c *Client) SubmitBlockAsync(block *bitumutil.Block, options *bitumjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
	...
	cmd := bitumjson.NewSubmitBlockCmd(blockHex, options)
	return c.sendCmd(cmd)
}

// SubmitBlock attempts to submit a new block into the Bitum network.
func (c *Client) SubmitBlock(block *bitumutil.Block, options *bitumjson.SubmitBlockOptions) error {
