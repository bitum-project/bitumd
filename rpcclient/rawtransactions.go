...
func (r FutureGetRawTransactionResult) Receive() (*bitumutil.Tx, error) {
	...
	return bitumutil.NewTx(&msgTx), nil
}
...
func (c *Client) GetRawTransactionAsync(txHash *chainhash.Hash) FutureGetRawTransactionResult {
	...
	cmd := bitumjson.NewGetRawTransactionCmd(hash, bitumjson.Int(0))
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*bitumutil.Tx, error) {
...
func (r FutureGetRawTransactionVerboseResult) Receive() (*bitumjson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var rawTxResult bitumjson.TxRawResult
...
func (c *Client) GetRawTransactionVerboseAsync(txHash *chainhash.Hash) FutureGetRawTransactionVerboseResult {
	...
	cmd := bitumjson.NewGetRawTransactionCmd(hash, bitumjson.Int(1))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawTransactionVerbose(txHash *chainhash.Hash) (*bitumjson.TxRawResult, error) {
...
func (r FutureDecodeRawTransactionResult) Receive() (*bitumjson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) DecodeRawTransactionAsync(serializedTx []byte) FutureDecodeRawTransactionResult {
	...
	cmd := bitumjson.NewDecodeRawTransactionCmd(txHex)
	return c.sendCmd(cmd)
}

// DecodeRawTransaction returns information about a transaction given its
// serialized bytes.
func (c *Client) DecodeRawTransaction(serializedTx []byte) (*bitumjson.TxRawResult, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []bitumjson.TransactionInput,
	amounts map[bitumutil.Address]bitumutil.Amount, lockTime *int64, expiry *int64) FutureCreateRawTransactionResult {

	convertedAmts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmts[addr.String()] = amount.ToCoin()
	}
	cmd := bitumjson.NewCreateRawTransactionCmd(inputs, convertedAmts, lockTime, expiry)
	return c.sendCmd(cmd)
}

// CreateRawTransaction returns a new transaction spending the provided inputs
// and sending to the provided addresses.
func (c *Client) CreateRawTransaction(inputs []bitumjson.TransactionInput,
	amounts map[bitumutil.Address]bitumutil.Amount, lockTime *int64, expiry *int64) (*wire.MsgTx, error) {
...
type SStxCommitOut struct {
	...
	CommitAmt  bitumutil.Amount
	ChangeAddr bitumutil.Address
	ChangeAmt  bitumutil.Amount
}
...
func (c *Client) CreateRawSStxAsync(inputs []bitumjson.SStxInput,
	amount map[bitumutil.Address]bitumutil.Amount,
	...
	convertedCouts := make([]bitumjson.SStxCommitOut, len(couts))
	...
	cmd := bitumjson.NewCreateRawSStxCmd(inputs,
		convertedAmt,
		convertedCouts)
...
// and sending to the provided addresses.
func (c *Client) CreateRawSStx(inputs []bitumjson.SStxInput,
	amount map[bitumutil.Address]bitumutil.Amount,
...
func (c *Client) CreateRawSSGenTxAsync(inputs []bitumjson.TransactionInput,
	votebits uint16) FutureCreateRawSSGenTxResult {

	cmd := bitumjson.NewCreateRawSSGenTxCmd(inputs, votebits)
	return c.sendCmd(cmd)
}

// CreateRawSSGenTx returns a new transaction spending the provided inputs
// and sending to the provided addresses.
func (c *Client) CreateRawSSGenTx(inputs []bitumjson.TransactionInput,
...
func (c *Client) CreateRawSSRtxAsync(inputs []bitumjson.TransactionInput, fee bitumutil.Amount) FutureCreateRawSSRtxResult {
	feeF64 := fee.ToCoin()
	cmd := bitumjson.NewCreateRawSSRtxCmd(inputs, &feeF64)
	return c.sendCmd(cmd)
}

// CreateRawSSRtx returns a new SSR transactionm (revoking an sstx).
func (c *Client) CreateRawSSRtx(inputs []bitumjson.TransactionInput, fee bitumutil.Amount) (*wire.MsgTx, error) {
...
func (c *Client) SendRawTransactionAsync(tx *wire.MsgTx, allowHighFees bool) FutureSendRawTransactionResult {
	...
	cmd := bitumjson.NewSendRawTransactionCmd(txHex, &allowHighFees)
	return c.sendCmd(cmd)
}
...
func (r FutureSignRawTransactionResult) Receive() (*wire.MsgTx, bool, error) {
	...
	var signRawTxResult bitumjson.SignRawTransactionResult
...
func (c *Client) SignRawTransactionAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := bitumjson.NewSignRawTransactionCmd(txHex, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction2Async(tx *wire.MsgTx, inputs []bitumjson.RawTxInput) FutureSignRawTransactionResult {
	txHex := ""
	if tx != nil {
		// Serialize the transaction and convert to hex string.
		buf := bytes.NewBuffer(make([]byte, 0, tx.SerializeSize()))
	...
	cmd := bitumjson.NewSignRawTransactionCmd(txHex, &inputs, nil, nil)
	return c.sendCmd(cmd)
}
...
// transactions.
func (c *Client) SignRawTransaction2(tx *wire.MsgTx, inputs []bitumjson.RawTxInput) (*wire.MsgTx, bool, error) {
...
func (c *Client) SignRawTransaction3Async(tx *wire.MsgTx,
	...
	cmd := bitumjson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction4Async(tx *wire.MsgTx,
	inputs []bitumjson.RawTxInput, privKeysWIF []string,
	...
	cmd := bitumjson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		bitumjson.String(string(hashType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawSSGenTxAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := bitumjson.NewSignRawTransactionCmd(txHex, &[]bitumjson.RawTxInput{},
		nil, bitumjson.String("ssgen"))
	return c.sendCmd(cmd)
}
...
func (c *Client) SearchRawTransactionsAsync(address bitumutil.Address, skip,
	count int, reverse bool,
	filterAddrs []string) FutureSearchRawTransactionsResult {

	addr := address.EncodeAddress()
	verbose := bitumjson.Int(0)
	prevOut := bitumjson.Int(0)
	cmd := bitumjson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
...
func (c *Client) SearchRawTransactions(address bitumutil.Address, skip, count int,
...
// Receive waits for the response promised by the future and returns the
// found raw transactions.
func (r FutureSearchRawTransactionsVerboseResult) Receive() ([]*bitumjson.SearchRawTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result []*bitumjson.SearchRawTransactionsResult
...
func (c *Client) SearchRawTransactionsVerboseAsync(address bitumutil.Address, skip,
	count int, includePrevOut bool, reverse bool,
	filterAddrs *[]string) FutureSearchRawTransactionsVerboseResult {

	addr := address.EncodeAddress()
	verbose := bitumjson.Int(1)
	prevOut := bitumjson.Int(0)
	if includePrevOut {
		prevOut = bitumjson.Int(1)
	}
	cmd := bitumjson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
		prevOut, &reverse, filterAddrs)
	return c.sendCmd(cmd)
...
func (c *Client) SearchRawTransactionsVerbose(address bitumutil.Address, skip,
	count int, includePrevOut bool, reverse bool,
	filterAddrs []string) ([]*bitumjson.SearchRawTransactionsResult, error) {
