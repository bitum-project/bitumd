...
var helpDescsEnUS = map[string]string{
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are AMGR, ADXR, BCDB, BMGR, BITUMD, CHAN, DISC, PEER, RPCS, SCRP, SRVR, and TXMP.\n" +
	...
	"createrawsstx-amount--desc":  "The destination address as the key and the amount in BITUM as the value",
	...
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount in BITUM as the value",
	...
	"scriptpubkeyresult-addresses": "The Bitum addresses associated with this script",
	"scriptpubkeyresult-commitamt": "The ticket commitment value if the script is for a staking commitment",

	// Vout help.
	"vout-value":        "The amount in BITUM",
	...
	"decodescriptresult-addresses": "The Bitum addresses associated with this script",
	...
	"getblock-verbosetx":   "Specifies that each transaction is returned as a JSON object and only applies if the verbose flag is true (bitumd extension)",
	...
	"getcurrentnet--synopsis": "Get Bitum network the server is running on.",
	...
	"infochainresult-relayfee":        "The minimum relay fee for non-free transactions in BITUM/KB",
	...
	"infowalletresult-balance":         "The total Bitum balance of the wallet",
	...
	"infowalletresult-paytxfee":        "The transaction fee set in BITUM/KB",
	...
	"getrawmempoolverboseresult-fee":              "Transaction fee in bitum",
	...
	"gettxoutresult-value":         "The transaction amount in BITUM",
	...
	"searchrawtransactions-address":     "The Bitum address to search for",
	...
	"sendrawtransaction-allowhighfees": "Whether or not to allow insanely high fees (bitumd does not yet implement this parameter, so it has no effect)",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown bitumd.",
	"stop--result0":  "The string 'bitumd stopping.'",
	...
	"validateaddresschainresult-address": "The Bitum address (only when isvalid is true)",

	// ValidateAddressCmd help.
	"validateaddress--synopsis": "Verify an address is valid.",
	"validateaddress-address":   "Bitum address to validate",
	...
	"verifymessage-address":   "The Bitum address to use for the signature",
	...
	// EstimateFee help.
	"estimatefee--synopsis": "Returns the estimated fee in bitum/kb.",
	"estimatefee-numblocks": "(unused)",
	"estimatefee--result0":  "Estimated fee.",

	// EstimateSmartFee help.
	"estimatesmartfee--synopsis":     "Returns the estimated fee using the historical fee data in bitum/kb.",
	...
	"estimatesmartfee--result0":      "Estimated fee rate (in BITUM/KB).",
	...
	// TicketFeeInfo help.
	"ticketfeeinfo--synopsis":            "Get various information about ticket fees from the mempool, blocks, and difficulty windows (units: BITUM/kB)",
	...
	"ticketfeeinforesult-feeinfomempool": "Ticket fee information for all tickets in the mempool (units: BITUM/kB)",
	"ticketfeeinforesult-feeinfoblocks":  "Ticket fee information for a given list of blocks descending from the chain tip (units: BITUM/kB)",
	"ticketfeeinforesult-feeinfowindows": "Ticket fee information for a window period where the stake difficulty was the same (units: BITUM/kB)",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"decoderawtransaction":  {(*bitumjson.TxRawDecodeResult)(nil)},
	"decodescript":          {(*bitumjson.DecodeScriptResult)(nil)},
	"estimatefee":           {(*float64)(nil)},
	"estimatesmartfee":      {(*float64)(nil)},
	"estimatestakediff":     {(*bitumjson.EstimateStakeDiffResult)(nil)},
	...
	"getaddednodeinfo":      {(*[]string)(nil), (*[]bitumjson.GetAddedNodeInfoResult)(nil)},
	"getbestblock":          {(*bitumjson.GetBestBlockResult)(nil)},
	"generate":              {(*[]string)(nil)},
	"getbestblockhash":      {(*string)(nil)},
	"getblock":              {(*string)(nil), (*bitumjson.GetBlockVerboseResult)(nil)},
	"getblockchaininfo":     {(*bitumjson.GetBlockChainInfoResult)(nil)},
	"getblockcount":         {(*int64)(nil)},
	"getblockhash":          {(*string)(nil)},
	"getblockheader":        {(*string)(nil), (*bitumjson.GetBlockHeaderVerboseResult)(nil)},
	"getblocksubsidy":       {(*bitumjson.GetBlockSubsidyResult)(nil)},
	"getblocktemplate":      {(*bitumjson.GetBlockTemplateResult)(nil), (*string)(nil), nil},
	"getcfilter":            {(*string)(nil)},
	"getcfilterheader":      {(*string)(nil)},
	"getchaintips":          {(*[]bitumjson.GetChainTipsResult)(nil)},
	"getconnectioncount":    {(*int32)(nil)},
	"getcurrentnet":         {(*uint32)(nil)},
	"getdifficulty":         {(*float64)(nil)},
	"getstakedifficulty":    {(*bitumjson.GetStakeDifficultyResult)(nil)},
	"getstakeversioninfo":   {(*bitumjson.GetStakeVersionInfoResult)(nil)},
	"getstakeversions":      {(*bitumjson.GetStakeVersionsResult)(nil)},
	"getgenerate":           {(*bool)(nil)},
	"gethashespersec":       {(*float64)(nil)},
	"getheaders":            {(*bitumjson.GetHeadersResult)(nil)},
	"getinfo":               {(*bitumjson.InfoChainResult)(nil)},
	"getmempoolinfo":        {(*bitumjson.GetMempoolInfoResult)(nil)},
	"getmininginfo":         {(*bitumjson.GetMiningInfoResult)(nil)},
	"getnettotals":          {(*bitumjson.GetNetTotalsResult)(nil)},
	"getnetworkhashps":      {(*int64)(nil)},
	"getpeerinfo":           {(*[]bitumjson.GetPeerInfoResult)(nil)},
	"getrawmempool":         {(*[]string)(nil), (*bitumjson.GetRawMempoolVerboseResult)(nil)},
	"getrawtransaction":     {(*string)(nil), (*bitumjson.TxRawResult)(nil)},
	"getticketpoolvalue":    {(*float64)(nil)},
	"gettxout":              {(*bitumjson.GetTxOutResult)(nil)},
	"getvoteinfo":           {(*bitumjson.GetVoteInfoResult)(nil)},
	"getwork":               {(*bitumjson.GetWorkResult)(nil), (*bool)(nil)},
	"getcoinsupply":         {(*int64)(nil)},
	"help":                  {(*string)(nil), (*string)(nil)},
	"livetickets":           {(*bitumjson.LiveTicketsResult)(nil)},
	"missedtickets":         {(*bitumjson.MissedTicketsResult)(nil)},
	"node":                  nil,
	"ping":                  nil,
	"rebroadcastmissed":     nil,
	"rebroadcastwinners":    nil,
	"searchrawtransactions": {(*string)(nil), (*[]bitumjson.SearchRawTransactionsResult)(nil)},
	"sendrawtransaction":    {(*string)(nil)},
	"setgenerate":           nil,
	"stop":                  {(*string)(nil)},
	"submitblock":           {nil, (*string)(nil)},
	"ticketfeeinfo":         {(*bitumjson.TicketFeeInfoResult)(nil)},
	"ticketsforaddress":     {(*bitumjson.TicketsForAddressResult)(nil)},
	"ticketvwap":            {(*float64)(nil)},
	"txfeeinfo":             {(*bitumjson.TxFeeInfoResult)(nil)},
	"validateaddress":       {(*bitumjson.ValidateAddressChainResult)(nil)},
	"verifychain":           {(*bool)(nil)},
	"verifymessage":         {(*bool)(nil)},
	"version":               {(*map[string]bitumjson.VersionResult)(nil)},

	// Websocket commands.
	"loadtxfilter":                nil,
	"session":                     {(*bitumjson.SessionResult)(nil)},
...
func (c *helpCacher) rpcMethodHelp(method string) (string, error) {
	...
	help, err := bitumjson.GenerateHelp(method, helpDescsEnUS, resultTypes...)
	if err != nil {
		return "", err
	}
...
func (c *helpCacher) rpcUsage(includeWebsockets bool) (string, error) {
	...
	for k := range rpcHandlers {
		usage, err := bitumjson.MethodUsageText(k)
		if err != nil {
			return "", err
		}
