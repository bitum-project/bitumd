...
// arguments returns an array of arguments that be used to launch the bitumd
// process.
...
// to the bitumd process that is launched via Start().
...
func (n *node) start() error {
	...
	pid, err := os.Create(filepath.Join(n.config.String(), "bitumd.pid"))
	if err != nil {
		return err
	}
...
// stop interrupts the running bitumd process process, and waits until it exits
...
// shutdown terminates the running bitumd process, and cleans up all
