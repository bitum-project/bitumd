...
/*
Package txscript implements the Bitum transaction script language.

This package provides data structures and functions to parse and execute
bitum transaction scripts.

Script Overview

Bitum transaction scripts are written in a stack-base, FORTH-like language.

The Bitum script language consists of a number of opcodes which fall into
...
The vast majority of Bitum scripts at the time of this writing are of several
...
what conditions must be met in order to spend bitums.
