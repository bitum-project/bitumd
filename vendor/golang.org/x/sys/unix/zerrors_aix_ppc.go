...
const (
	...
	EABITUMSUPPORT    = syscall.Errno(0x42)
	...
	EPBITUMSUPPORT    = syscall.Errno(0x41)
...
var errorList = [...]struct {
	...
	{65, "EPBITUMSUPPORT", "protocol family not supported"},
	{66, "EABITUMSUPPORT", "addr family not supported by protocol"},
