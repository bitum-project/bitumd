...
// BlockHeader defines information about a block and is used in the bitum
...
// readBlockHeader reads a Bitum block header from r.  See Deserialize for
...
// writeBlockHeader writes a Bitum block header to w.  See Serialize for
