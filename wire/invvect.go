...
const (
	...
	InvTypeCodechainEntry InvType = 256 // Bitum updater
	InvTypePatch          InvType = 257 // Bitum updater
)
...
// InvVect defines a Bitum inventory vector which is used to describe data,
