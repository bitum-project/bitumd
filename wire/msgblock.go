...
// MsgBlock implements the Message interface and represents a bitum
...
// BtcDecode decodes from the Bitum wire protocol as it was sent across the
...
// the Bitum wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new Bitum block message that conforms to the
