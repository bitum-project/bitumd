...
// MsgGetData implements the Message interface and represents a bitum
...
// NewMsgGetData returns a new Bitum getdata message that conforms to the
...
// NewMsgGetDataSizeHint returns a new Bitum getdata message that conforms to
