...
// a single Bitum headers message.
const MaxBlockHeadersPerMsg = 2000

// MsgHeaders implements the Message interface and represents a Bitum headers
...
// NewMsgHeaders returns a new Bitum headers message that conforms to the
