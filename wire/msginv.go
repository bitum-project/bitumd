...
// MsgInv implements the Message interface and represents a Bitum inv message.
...
// NewMsgInv returns a new Bitum inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new Bitum inv message that conforms to the
