...
// MsgReject implements the Message interface and represents a Bitum reject
// message.
//
...
func (msg *MsgReject) MaxPayloadLength(pver uint32) uint32 {
	// Unfortunately the Bitum protocol does not enforce a sane
...
// NewMsgReject returns a new Bitum reject message that conforms to the
