...
const DefaultUserAgent = "/bitumwire:0.3.0/"

// MsgVersion implements the Message interface and represents a Bitum version
...
// NewMsgVersion returns a new Bitum version message that conforms to the
...
// and local address from conn and returns a new Bitum version message that
