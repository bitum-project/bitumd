...
// maxNetAddressPayload returns the max payload size for a Bitum NetAddress
...
type NetAddress struct {
	...
	// not present in the Bitum version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The Bitum protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  Bitum protocol mixes little and big endian.
